...
<html>
<head>
    <title>Login >> CRUD Project Management System</title>
...
<body>
	<section id="login">
        <header>
            <h2 style="color: white; text-align: center" class="uppercase">CRUD Project Management System</h2>
            <p class="uppercase"></p>
        </header>
    ...
    <div style="max-width:900px;margin:auto;padding:50px 0px 20px 0px">
		<div class="col-md-6" style="padding-top:30px">
    		<img src="<?php echo $this->base ?>/assets/img/default-logo.png" width="200" style="float:left;margin-left:20px;"> 
    	<div class="clearfix"></div>
    	</div>
    	<div class="col-md-6">
